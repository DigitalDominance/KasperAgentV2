...
COINGECKO_API_KEY = os.getenv("COINGECKO_API_KEY", "")  # Add this to your Heroku env
...
# Fetch Kasper market data from CoinGecko
...
def get_kasper_persona():
    return (
        ...
        "Encourage users to chat more, keep answers concise, and hype Kasper as the next big memecoin!"
	...
	" dont acidentally say punctuation, including * and other symbols, use grammer and tone instead "
    )
...
def main():
    ...
    loop.create_task(update_market_data())
